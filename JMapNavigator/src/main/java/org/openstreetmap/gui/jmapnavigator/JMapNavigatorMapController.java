...
/**
 * Map controller for JMapNavigator which implements map moving by pressing the right mouse button and zooming by float click or by mouse wheel.
 *
 * @author Jonas Grunert
 *
 */
@SuppressWarnings("javadoc")
public class JMapNavigatorMapController extends JMapController implements MouseListener, MouseMotionListener, MouseWheelListener {
